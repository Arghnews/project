...
badd +0 G_Cuboid.cpp
badd +8 Shader.hpp
badd +0 shaders/vertex.shader
badd +0 shaders/fragment.shader
badd +152 Main.cpp.backup
badd +674 before/VulkanProject/MyVulkan.cpp
badd +0 before/VulkanProject/TheMaster.cpp
argglobal
silent! argdel *
argadd Main.cpp
set stal=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 39 - ((14 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
normal! 0
tabedit before/VulkanProject/TheMaster.cpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 449 - ((22 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
449
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 21 - ((4 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 22 - ((13 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
