...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 76 - ((28 * winheight(0) + 28) / 56)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 32 + 29) / 58)
exe '2resize ' . ((&lines * 22 + 29) / 58)
argglobal
setlocal keymap=
setlocal noarabic
setlocal noautoindent
...
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 32 + 29) / 58)
exe 'vert 1resize ' . ((&columns * 132 + 70) / 140)
exe '2resize ' . ((&lines * 22 + 29) / 58)
exe 'vert 2resize ' . ((&columns * 132 + 70) / 140)
argglobal
setlocal keymap=
setlocal noarabic
setlocal noautoindent
