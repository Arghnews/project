...
set helplang=en
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/vim-go,~/.vim/bundle/molokai,~/.vim/bundle/vim-cpp-enhanced-highlight,~/.vim/bundle/vim-glsl,/usr/share/vim/vimfiles,/usr/share/vim/vim74,/usr/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/vim-go/after,~/.vim/bundle/molokai/after,~/.vim/bundle/vim-cpp-enhanced-highlight/after,~/.vim/bundle/vim-glsl/after
set shiftwidth=4
set softtabstop=4
set tabstop=4
...
set shortmess=aoO
badd +261 Network_Test.cpp
badd +23 Receiver.cpp
badd +22 Receiver.hpp
badd +2 Sender.cpp
badd +28 Sender.hpp
badd +72 World.cpp
badd +34 World.hpp
...
badd +1 Archiver.hpp
badd +1 Force.hpp
badd +0 Packet_Header.cpp
badd +0 Packet_Header.hpp
badd +0 Packet_Payload.cpp
badd +0 Packet_Payload.hpp
badd +0 Shot.hpp
badd +0 Packet.cpp
badd +0 Packet.hpp
badd +0 Connection.cpp
badd +5 Connection.hpp
badd +0 runMe.sh
args Network_Test.cpp
edit Main.cpp
...
silent! normal! zE
let s:l = 220 - ((13 * winheight(0) + 34) / 68)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 113 - ((29 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
113
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 52 + 35) / 70)
exe '2resize ' . ((&lines * 14 + 35) / 70)
argglobal
nnoremap <buffer> <silent> - :CCTreeRecurseDepthMinus
nnoremap <buffer> <silent> = :CCTreeRecurseDepthPlus
setlocal keymap=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 524 - ((19 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
524
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 47 - ((36 * winheight(0) + 33) / 67)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
47
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 29 - ((20 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 74 - ((52 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
74
