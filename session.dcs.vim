...
set shortmess=aoO
badd +10 Network_Test.cpp
badd +23 Receiver.cpp
badd +14 Receiver.hpp
badd +2 Sender.cpp
badd +27 Sender.hpp
badd +72 World.cpp
badd +34 World.hpp
...
silent! normal! zE
let s:l = 45 - ((42 * winheight(0) + 34) / 68)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 72 - ((27 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 58 - ((57 * winheight(0) + 33) / 67)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
58
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 68 - ((9 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 185 - ((33 * winheight(0) + 34) / 68)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
185
